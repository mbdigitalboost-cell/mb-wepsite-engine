...
import { createAddonAction, updateAddonAction, setAddonActiveAction, deleteAddonAction } from "./actions";
import { ProductAddonForm } from "./addon-form";
...
/**
 * FAZ 2C-2 — Product Add-ons (ör. "Yan Cep +100"), flat inline CRUD —
 * images/page.tsx ve variants/page.tsx ile AYNI iskelet. Read access
 * `requireStoreAccess` (store_viewer+) — her satırın kendi formu kendi
 * requireStoreEditorAccess/requireStoreAdminAccess'ini action içinde
 * BAĞIMSIZ olarak çağırır (addons/actions.ts).
 */
export default async function ProductAddonsPage({
  ...
  return (
    <div>
      ...
      <h1 className="mt-2 text-xl font-semibold tracking-tight">Ek Parçalar</h1>
