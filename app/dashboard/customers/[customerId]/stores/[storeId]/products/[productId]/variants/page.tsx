...
import { VariantOptionAssignmentForm } from "./variant-option-assignment-form";
import { DeleteOptionGroupButton } from "./delete-option-group-button";
...
/**
 * FAZ 2C-2 — Variants + Option Groups + Option Values, one page (mirrors
 * images/page.tsx's "flat inline CRUD" shape — brands/categories ile
 * aynı iskelet, ayrı bir list+new/[id] ağacı yerine tek sayfada
 * `<details>` ile açılır düzenleme). Read access `requireStoreAccess`
 * (store_viewer+) — her satırın kendi formu kendi
 * requireStoreEditorAccess/requireStoreAdminAccess'ini action içinde
 * BAĞIMSIZ olarak çağırır (variants/actions.ts).
 */
export default async function ProductVariantsPage({
  ...
  return (
    <div>
      ...
      <h1 className="mt-2 text-xl font-semibold tracking-tight">Varyantlar</h1>
